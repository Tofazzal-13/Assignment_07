            ...
            <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-6">
                <div className="md:col-span-4 space-y-6">
                    ...
                    <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex flex-col items-center text-center">
                        ...
                        <div className="flex gap-2 mt-2">
                            <span className="bg-red-500 text-white text-[10px] px-3 py-1 rounded-full font-bold uppercase tracking-wide">Overdue</span>
                            <span className="bg-emerald-100 text-emerald-600 text-[10px] px-3 py-1 rounded-full font-bold uppercase tracking-wide">Family</span>
                        </div>
                        <p className="text-gray-500 italic mt-4 text-sm">"Former colleague, great mentor"</p>
                ...
                <div className="md:col-span-8 space-y-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        ...
                        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 text-center">
                            <h3 className="text-xl font-bold text-emerald-800">Feb 27, 2026</h3>
